...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    fonts-dejavu-core fonts-noto fonts-beng fonts-beng-extra fonts-noto-color-emoji fontconfig \
    libraqm0 libraqm-dev libfreetype6 libfreetype6-dev libharfbuzz0b libharfbuzz-dev libfribidi0 libfribidi-dev \
    libjpeg-dev zlib1g-dev libpng-dev build-essential \
